...
window.AppLocales.en = {
    ...
    header: {
        title: 'Average Speed Camera Sections in Bulgaria (as of 27.07.2026)',
        fines: '💰 Fines',
    ...
    pages: {
        about: {
            ...
            noteTitle: '📝 Note',
            noteText: 'This project is for informational purposes. Please follow speed limits everywhere, not only in marked sections. The data shows the Bulgarian road sections current as of 27.07.2026 that are monitored for average speed violations.',
        ...
        fines: {
            ...
            important: '⚠️ Important: For every additional 5 km/h over the 50 km/h threshold, the fine increases by 50 BGN.',
            ...
            legalText: 'Average speed fines are imposed under the Bulgarian Road Traffic Act, Article 182, paragraphs 1 and 2. The sanctions are the same as those for speeding detected by fixed or mobile speed cameras.',
